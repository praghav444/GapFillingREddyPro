...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Calculate UTC TIME OFFSET based on site location (Lat-Long)
site_info = pd.read_csv("sites_info_Fluxnet2015_ICOS_AMFFLX.csv")
...
for i, row in site_info.iterrows():
    ...
    if timezone_str:
        ...
        offset_hours = offset.total_seconds() / 3600 if offset else np.nan
    else:
        offset_hours = np.nan
...
sample_ds['Hour'] = sample_ds['DateTime'].dt.hour + sample_ds['DateTime'].dt.minute/60
lat = -54.9733 
long = -66.7335
tf = TimezoneFinder()
timezone_str = tf.timezone_at(lng= long, lat=lat)
